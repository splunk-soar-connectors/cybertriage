...
class CyberTriageConnector(BaseConnector):
    ...
    def _handle_triage_endpoint(self, param):
        ...
        mal_scan = "true" if param['malware_scan'] == "Enabled" else "false"
        file_upload = "true" if param['file_upload'] == "Enabled" else "false"
        fast_scan = "false" if param['full_scan'] == "Enabled" else "true"
        ...
        api_data.update({'malwareScanRequested': mal_scan})
        api_data.update({'sendContent': file_upload})
        api_data.update({'fastScan': fast_scan})
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'triage_endpoint':
            ret_val = self._handle_triage_endpoint(param)
